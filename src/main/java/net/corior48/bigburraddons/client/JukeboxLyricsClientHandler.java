...
import net.corior48.bigburraddons.client.screen.LyricsPopupScreen;
import net.corior48.bigburraddons.client.util.DiscLyrics;
import net.corior48.bigburraddons.common.DiscCatalog;
import net.corior48.bigburraddons.network.JukeboxLyricsResultPayload;
import net.minecraft.client.Minecraft;
import net.minecraft.network.chat.Component;

public class JukeboxLyricsClientHandler {
